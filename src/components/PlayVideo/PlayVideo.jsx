...
const fetchVideoData=async()=>{
    ...
    // const videoDetails_url= `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%CcontentDetails%2Cstatistics&id=${videoId}&key=${API_KEY}`;
...
const fetchOtherData =async ()=>{
    ...
    // const channelData_url=`https://youtube.googleapis.com/youtube/v3/channels?part=snippet,CcontentDetails%2Cstatistics&id=${apiData.snippet.channelId}&key=${API_KEY}`;
